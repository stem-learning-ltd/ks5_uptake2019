...
```{r engagement data, echo = F, warning = F, message = F}
library(kableExtra)
...
```{r uptake data, echo = F, warning=FALSE, message=FALSE}
...
kable(uptake, col.names = c("Year", "Number of Students entering 1+ STEM A level", "Total GCSE Students")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = F) 
